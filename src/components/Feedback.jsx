...
const Feedback = () => {
  ...
  >
    <div className="bg-white p-6 rounded-xl shadow-xl w-[90%] max-w-md md:max-w-lg h-auto max-h-[70vh] flex flex-col">
      ...
      {/* Formulário */}
      <form action="https://formspree.io/f/mqapqejd" method="POST" className="flex flex-col flex-grow">
        <textarea
          name="message"
          className="w-full p-3 border border-gray-300 rounded-lg shadow-inner text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 resize-none flex-grow"
