  ...
  return (
    ...
    <div>
        ...
        <div className='flex flex-col items-center p-4 bg-stone-200'>
            <h1 id='title2' className='text-3xl font-bold text-center pt-20'>Bem-vindo ao Digital Sanctum</h1>
            <p className='text-center mt-2 w-[65%] text-sm   pt-10 pb-10 italic text-gray-600'>
