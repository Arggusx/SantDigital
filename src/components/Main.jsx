      ...
      <body class="bg-amber-50 font-serif">
        ...
        <main class="max-w-4xl mx-auto px-4 py-8 md:py-16">
          <section class="text-center mb-16">
            <h1 class="text-4xl md:text-6xl font-cursive text-amber-800 mt-20 mb-4 italic">Oratio Daily</h1>
            <p class="text-md md:text-2xl text-amber-700 mb-8">Um refúgio digital para oração e reflexão espiritual</p>
            <div class="w-24 h-1 bg-amber-300 mx-auto mb-12"></div>
          </section>
          <section class="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <p class="md:text-lg text-md text-amber-900 mb-6 leading-relaxed">
              ...
              <p class="md:text-lg text-md text-amber-900 mb-8 leading-relaxed">
                Comece sua jornada espiritual hoje mesmo, com orientações simples e conteúdo que nutre a alma.
              </p>
              <a href="#" class="inline-block bg-amber-700 md:text-lg text-md hover:bg-amber-800 text-white font-medium py-3 px-8 rounded-full transition duration-300 shadow-md hover:shadow-lg">
          ...
          <section class="bg-white bg-opacity-70 p-8 border-3 border-gray-200 rounded-lg shadow-sm mb-16">
            <h2 class="text-2xl md:text-3xl text-amber-800 mb-6 text-center">Oração do Dia</h2>
            <blockquote class="text-amber-900 italic md:text-lg text-md leading-relaxed mb-6">
            ...
            <p class="text-amber-700 text-right md:text-lg text-md">- São Francisco de Assis</p>
          </section>
        </main>
      </body>
