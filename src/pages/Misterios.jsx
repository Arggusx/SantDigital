...
const Misterios = () => {
  return (
    <div className="p-4">
        <h1 className="text-2xl font-bold text-center pt-20">Mistério do Dia</h1>
        <p className="text-gray-700 text-center mt-2">Aqui você verá os mistérios do terço para cada dia.</p>
        <hr className="pl-4 border-t-3 border-black-400 my-7 w-full rounded" />
        <h2 className='mt-10 text-2xl font-bold italic ml-10 mr-10 text-center'>Para rezar o terço corretamente, é importante saber qual mistério corresponde ao dia. Cada dia da semana tem um conjunto específico de mistérios que orientam a oração e a meditação. Confira abaixo os mistérios do dia e siga essa tradição para uma experiência mais completa e significativa.</h2>
        <hr className="pl-4 border-t-3 border-black-400 my-7 w-full rounded" />
        <li id='gozosos' className='ml-5 mt-15 text-xl font-bold'>Mistérios Gozosos (segundas e sábados, e nos domingos do Advento)</li>
            <ol className='ml-20 mt-4 whitespace-pre-line font-body text-lg list-decimal marker:font-bold'>
