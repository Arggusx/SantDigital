...
const Misterios = () => {
  return (
    <div className="p-4">
        <h1 id='title2' className="font-bold pl-5 pt-20 underline underline-offset-4 decoration-2">Mistérios Diários</h1>
        <hr className="pl-4 border-t-3 border-yellow-400 mt-5 w-full rounded" />
        <h2 className='mt-5 text-2xl font-bold italic ml-10 mr-10 text-center'>Para rezar o terço corretamente, é importante saber qual mistério corresponde ao dia. Cada dia da semana tem um conjunto específico de mistérios que orientam a oração e a meditação. Confira abaixo os mistérios do dia e siga essa tradição para uma experiência mais completa e significativa.</h2>
        <hr className="pl-4 border-t-3 border-yellow-400 mt-5 w-full rounded" />
