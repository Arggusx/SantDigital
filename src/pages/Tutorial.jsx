    ...
    <div className="p-4">
        ...
        <div>
            ...
            <div className="flex flex-col items-center justify-center h-screen">
                <img className='w-150 mt-20 md:mt-60' src={tercoTutor} alt="" />
            </div>

            <div className='mt-30 md:mt-90'>
                ...
                <span id='oferecimento' className='mb-5 mt-15  text-2xl font-bold font-oswald'>OFERECIMENTO</span>
                    ...
                    <p className='border-l-2 border-gray-400 mb-15 pl-7 ml-8 mt-4 font-body md:text-lg  text-gray-800 italic'>
                        ﾠﾠﾠﾠDivino Jesus, nós Vos oferecemos este terço que vamos rezar, meditando nos mistérios da Vossa Redenção. Concedei-nos, por intercessão da Virgem Maria, Mãe de Deus e nossa Mãe, as virtudes que nos são necessárias para bem rezá-lo e a graça de ganharmos as indulgências desta santa devoção.
                    </p>
                ...
                <span id='credo' className='mb-5 mt-15 text-2xl font-bold font-oswald'>CREDO</span>
                    ...
                    <p className='border-l-2 border-gray-400 mb-8 pl-7 ml-8 mt-4 whitespace-pre-line font-body md:text-lg  text-gray-800 italic'>
                        ﾠﾠﾠﾠCreio em Deus Pai Todo-Poderoso, Criador do Céu e da Terra; e em Jesus Cristo, Seu único Filho, Nosso Senhor; que foi concebido pelo poder do Espírito Santo. Nasceu da Virgem Maria, padeceu sob Pôncio Pilatos, foi crucificado, morto e sepultado; desceu à mansão dos mortos; Ressuscitou ao terceiro dia;  aos Céus, está sentado à direita de Deus Pai Todo-Poderoso, donde há de vir a julgar os vivos e os mortos. Creio no Espírito Santo, na Santa Igreja Católica, na Comunhão dos Santos, na remissão dos pecados, na ressurreição da carne, na vida eterna. <strong  >Amém.</strong></p>
                ...
                <span id='gloria' className='mb-5 mt-15 text-2xl font-bold'>JACULATÓRIA</span>
                    ...
                    <p className='border-l-2 border-gray-400 pl-7 ml-8 mt-4 whitespace-pre-line font-body md:text-lg  text-gray-800 italic'>-ﾠﾠGlória ao Pai, ao Filho e ao Espírito Santo. Como era no princípio, agora e sempre. <strong>Amém.</strong></p>    
                    <span className='ml-8 border-l-2 border-gray-400 py-1'>ﾠ</span>
                    <p className='border-l-2 border-gray-400 mb-8 pl-7 ml-8 whitespace-pre-line font-body md:text-lg  text-gray-800 italic'>-ﾠﾠÓ meu Jesus, perdoai-nos e livrai-nos do fogo do inferno; levai as almas todas para o Céu, principalmente as que mais precisarem da vossa misericórdia.</p>
                    <p className=' mb-8 pl-7 whitespace-pre-line font-body md:text-lg  text-red-900 font-bold italic'>(Depois que seguir todos esses passos, reze sempre a Jaculatória, anuncie <Link to="/home/misterio" className='underline underline-offset-3 text-yellow-500'> qual mistério</Link> será contemplado [Ex.: No Segundo Mistério Glorioso contemplamos...], um Pai-Nosso e dez Ave-Marias, faça isso até terminar de rezar  e contemplar todos os 5 mistérios)</p>
                ...
                <span id='salve' className='mb-5 text-2xl mt-15 font-bold'>SALVE RAINHA</span>
                    ...
                    <p className='mt-8 mb-8 pl-7 whitespace-pre-line font-body md:text-lg  text-red-900 font-bold italic'>Obs.: Não se esqueca de fazer o sinal da cruz novamente após o término.</p>
            </div>
        </div>
