...
const Oracoes = () => {
  return (
    <div className="p-4">
      <h1 id='title2' className="font-bold pl-5 pt-20 underline underline-offset-4 decoration-2">Orações</h1>
      ...
      <p id='oracoes-title' className='mt-15 ml-5 text-2xl font-bold'>Orações para rezar o terço:</p>
            ...
            <blockquote className=' border-l-2 border-gray-300 pl-7 ml-8 mt-4 whitespace-pre-line font-body text-lg  text-gray-800 italic'>
            ...
            <h1 className="ml-5 mt-5 text-xl font-bold underline">Ave Maria</h1>
            <p className='border-l-2 border-gray-300 pl-7 ml-8 mt-4 whitespace-pre-line font-body text-lg  text-gray-800 italic'>
                Ave Maria, cheia de graça, o Senhor é convosco. <br />Bendita sois vós entre as mulheres, <br />e bendito é o fruto do vosso ventre, Jesus. <br />Santa Maria, Mãe de Deus, <br />rogai por nós, pecadores, <br />agora e na hora de nossa morte. <strong>Amém!</strong>
            </p>
